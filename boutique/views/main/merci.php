    ...
    <div class="container-fluid">
        ...
        <div class="row">                               
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <form class="form-inline ml-5 my-2 my-lg-0" method="post" action="<?php echo WWW_ROOT; ?>pages/merci">
            ...
            <section class="col-sm-12 col-md-9 my-5 text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="jumbotron">
                                <h1 class="display-5 mb-5">MERCI POUR VOTRE ACHAT</h1><br>
                                ...
                                <h5><a class="nav-link" href="<?= WWW_ROOT ?>pages/index">A Bientôt, sur www.panamaHats.com</a></h5>
                            </div>
                        </div>
                        <div class="col-md-4">
